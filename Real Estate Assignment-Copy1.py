...
# ### Recommendation
# 1. We can continue to encourage our top customers so as to encourage other trying customers, we can do this for our top 5 customers by providing discounted sales price, this will enable more patronage and trust with our organization. 
# 2. Our trend over the years shows upward trend between 2019/20, this way we need to keep this trend moving up which may be as a results of positive consumer confidence in the economy and in what we do.
